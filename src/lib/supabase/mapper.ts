...
type DbItemType = Database["public"]["Tables"]["items"]["Row"];
type DbInsertItemType = Database["public"]["Tables"]["items"]["Insert"];
type DbUpdateItemType = Database["public"]["Tables"]["items"]["Update"];
...
export function mapItemToDb(item: ItemType): DbInsertItemType | DbUpdateItemType {
  return {
    id: item.id,
    uuid: item.uuid,
    user_id: item.userId,
